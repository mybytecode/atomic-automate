...
VALUES('{billingTransactionId}', {billingAmount}, {dueAmount}, '{billingAccountId}', '', 'USD', '{discountId}', {discountAmount}, 0, '', '', '', '', '', 'treasury', 'charge_on_aum', 'pending',  '0001-01-03T13:22:58Z', '0001-01-03T13:22:58Z', '{createdAt}', CURRENT_TIMESTAMP, 'USD', '{remark}');`