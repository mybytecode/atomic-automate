...
export default function Home() {
  ...
  const parseDetails = (e: any) => {
    const kyb = parse(JSON.parse(KYB))
    const participant = parseParticipant(JSON.parse(KYB))
    console.log(kyb)
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <div>
          <textarea onChange={parseDetails} className='txt'></textarea>
        </div>
      </main>
    </>
  )
